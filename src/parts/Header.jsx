...
export default function Header({ theme, position }) {
  const [toggleMainMenu, setToggelMainMenu] = useState(false);
  const [isCartChanged, setCardCanged] = useState(false);
                ...
                <Link
                  ...
                  className={[
                    theme === "white"
                      ...
                      : "text-white md:text-black hover:underline",
                  ]}
                >
                  Catalog
                </Link>
            ...
            <ul className="items-center flex">
              <li className="ml-6 block md:hidden">
                <button
                  ...
                  onClick={() => setToggelMainMenu((prev) => !prev)}
                >
                  <svg
